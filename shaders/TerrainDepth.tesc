...
void main() {
	...
	// 	vec4 eyeSpacePos00 = view * (gl_in[0].gl_Position + vec4(worldPos, 0.0));
	// 	vec4 eyeSpacePos01 = view * (gl_in[1].gl_Position + vec4(worldPos, 0.0));
	// 	vec4 eyeSpacePos10 = view * (gl_in[2].gl_Position + vec4(worldPos, 0.0));
	// 	vec4 eyeSpacePos11 = view * (gl_in[3].gl_Position + vec4(worldPos, 0.0));
